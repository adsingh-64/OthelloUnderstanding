...
def evaluate_decision_trees(
    ...
    # We don't need to cache activations for evaluation since we're using decision trees
    # But we need binary activations for some operations, so we'll create dummy ones
    neuron_acts = {}
    binary_acts = {}
...
def main():
    ...
    ablate_not_selected_options = [False]
    add_error_options = [False]
